An AAA server based on CAS (Yale Central Authentication Service project), it provides similar Authentication scheme as Amazon AWS. You can use it to setup a SSO (Single Sign On) or Authentication server.  
